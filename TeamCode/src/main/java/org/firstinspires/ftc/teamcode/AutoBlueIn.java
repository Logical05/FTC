...
@Config
@Autonomous(name="AutoBlueIn", group = "In")
public class AutoBlueIn extends Robot {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            Move(0.9, 4.5, 0.23, -1.47, 1.12, 0.4, 0);
            Lift(1300);
            if (signalPos == 'R') {
                Move(0.7, 4.5, 0.23, -1.47, 1.5, 0.25, 0);
            }
            if (signalPos == 'L') {
                Move(0.7, 4.5, 0.23, -1.47, 0.9, 0.25, 0);
            }
            Dropper();
            Lift(0);
//            Move(0.7, 4.75, 0.23, -1.33, 2.35, 0.25, 0); // Mid
            Move(0.7, 4.75, 0.23, -1.47, 0.25, 0.25, 0); // Corner
        }
    }
}
