...
@Config
@Autonomous(name="AutoRedIn", group = "In")
public class AutoRedIn extends Robot {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            Move(0.7, 4.5, 0.23, 0, 1, 0.25, 0);
            Turn(-90, 0.25);
            Move(0.8, 4.5, 0.23, 0, 1.12, 0.25, 0);
            if (signalPos == 'L') {
                Drop();
            }
            if (signalPos == 'R') {
                Move(0.7, 4.5, 0.23, 0.775, 1.12, 0.25, 0);
                Drop();
            }
            Move(0.9, 4.5, 0.23, 1.33, 1.12, 0.4, 0);
            Lift(950);
            if (signalPos == 'L') {
                Move(0.7, 4.5, 0.23, 1.33, 1.5, 0.25, 0);
            }
            if (signalPos == 'R') {
                Move(0.7, 4.5, 0.23, 1.33, 0.8, 0.25, 0);
            }
            Dropper();
            Lift(0);
//            Move(0.7, 4.75, 0.23, 1.33, 2.35, 0.25, 0); // Mid
            Move(0.7, 4.75, 0.23, 1.33, 0.25, 0.25, 0); // Corner
            Move(0.9, 4.75, 0.23, 1.65, 2.35, 0.25, 0);
        }
    }
}
